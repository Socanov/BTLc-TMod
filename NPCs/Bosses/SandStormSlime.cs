...
namespace BTLc.NPCs.Bosses
{
    ...
    public class SandStormSlime : BTLcNPC
    {
        ...
        public override void AI()
        {
            ...
            if(!player.ZoneDesert && Vector2.Distance(player.Center, NPC.Center) > 1500f)
            {
                NPC.life = 0;
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.weapons.Melee.DesertGodSword>(), 4));
        }
    }
}
